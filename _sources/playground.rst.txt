...
.. raw:: html
   ...
   <div id="atlas-playground" class="atlas-playground" data-package="pyworldatlas==0.9.4">
     ...
     <div class="atlas-runtime-facts" aria-label="Playground runtime">
       ...
       <span>PyWorldAtlas <strong data-role="library-version">0.9.4</strong></span>
...
This is the real ``pyworldatlas==0.9.4`` wheel published on PyPI, not a
