...
.. raw:: html
   ...
   <div id="atlas-playground" class="atlas-playground" data-package="pyworldatlas==0.8.0">
     ...
     <div class="atlas-runtime-facts" aria-label="Playground runtime">
       ...
       <span>PyWorldAtlas <strong data-role="library-version">0.8.0</strong></span>
...
This is the real ``pyworldatlas==0.8.0`` wheel published on PyPI, not a
